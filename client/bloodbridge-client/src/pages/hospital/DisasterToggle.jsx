...
const DisasterToggle = () => {
  ...
  const handleConfirm = async () => {
    ...
    setToggling(true)
    try {
      await api.put('/hospital/disaster-toggle', { enable: newMode })
