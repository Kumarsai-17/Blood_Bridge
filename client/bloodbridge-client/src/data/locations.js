// Indian States and All Districts data (Latest 2024)
export const statesAndCities = {
  ...
  "Arunachal Pradesh": [
    ...
    "West Siang", "Itanagar Capital Complex", "Kamle", "Kra Daadi", "Lepa Rada", "Shi Yomi"
  ],
  "Assam": [
  ...
  "Madhya Pradesh": [
    ...
    "Narsinghpur", "Neemuch", "Niwari", "Nagda", "Panna", "Raisen", 
  ...
  "Nagaland": [
    ...
    "Chumukedima", "Niuland", "Shamator", "Tseminyu"
  ],
  "Odisha": [
  ...
  "Punjab": [
    ...
    "Malerkotla", "Mansa", "Moga", "Mohali", "Muktsar", "Pathankot", 
  ...
  "Telangana": [
    ...
    "Khammam", "Komaram Bheem", "Mahabubabad", "Mahbubnagar", "Mancherial", "Medak", 
